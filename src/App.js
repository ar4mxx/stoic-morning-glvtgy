        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="flex items-center">
              <a
                href="#contact"
                className="bg-blue-600 text-white px-6 py-2.5 rounded-full font-bold hover:bg-blue-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
          ...
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center space-x-2 bg-blue-500/20 rounded-full px-4 py-1.5 mb-8 border border-blue-400/30">
              ...
              <span className="text-sm font-semibold text-blue-300 tracking-wide uppercase">
                DFW's Premier Call Capture Agency
              </span>
            </div>
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight mb-8 leading-tight">
              Stop Losing $2,000 Jobs to{" "}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-300">
                Voicemail.
              </span>
            </h1>
            <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
              When you're under a sink, you can't answer the phone. Our AI
              instantly texts back missed calls, answers questions, and books
              the job before they call your competitor.
            </p>
            <div className="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-6">
              <a
                href="#contact"
                className="w-full sm:w-auto bg-blue-600 text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-blue-500 transition-all flex items-center justify-center group shadow-xl shadow-blue-900/20"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            <h2 className="text-3xl font-bold text-slate-900 mb-4">
              The Brutal Math of Home Services
            </h2>
            <p className="text-lg text-slate-600">
              85% of customers whose calls go unanswered will not leave a
              voicemail. They simply hang up and call the next business on
              Google.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 text-center">
              ...
              <p className="text-slate-600">
                You're busy on a job site. A homeowner with a burst pipe calls,
                but you can't get to the phone.
              </p>
            </div>
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 text-center">
              ...
              <p className="text-slate-600">
                They hear your voicemail greeting and immediately hang up. It's
                an emergency, they need an answer now.
              </p>
            </div>
            <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 text-center">
              <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
              ...
              <p className="text-slate-600">
                They call your competitor who answers. You just lost a $1,500+
                job because you were doing your job.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2">
              ...
              <p className="text-xl text-slate-600 mb-10 leading-relaxed">
                Lone Star Systems links directly to your existing phone number.
                The second a call is missed, our AI goes to work.
              </p>
              ...
              <div className="space-y-8">
                <div className="flex">
                  ...
                  <div className="ml-6">
                    ...
                    <p className="text-slate-600 text-lg">
                      Within 5 seconds of a missed call, the customer receives a
                      text: "Hey this is John's Plumbing, I'm on a job site!
                ...
                <div className="flex">
                  ...
                  <div className="ml-6">
                    ...
                    <p className="text-slate-600 text-lg">
                      Our custom-trained AI chats with them, asks for photos of
                      the issue, and answers basic pricing questions.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-6">
                    ...
                    <p className="text-slate-600 text-lg">
                      You get a summary email of the exact issue, and the
                      customer is told you will call them as soon as you are
                      free. Job saved.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-slate-50 h-full p-4 space-y-4 pt-6">
                  <div className="flex justify-end">
                    <div className="bg-blue-600 text-white rounded-2xl rounded-tr-sm px-4 py-2 text-sm max-w-[80%] shadow-sm">
                      Hey this is the automated assistant for Local Plumbing. We
                      saw we just missed your call! I'm under a sink right now,
                      but how can we help?
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-gray-200 text-slate-900 rounded-2xl rounded-tl-sm px-4 py-2 text-sm max-w-[80%]">
                      Hi, my water heater just burst in the garage and there's
                      water everywhere! Do you guys do emergency replacements?
                    </div>
                  </div>
                  <div className="flex justify-end">
                    <div className="bg-blue-600 text-white rounded-2xl rounded-tr-sm px-4 py-2 text-sm max-w-[80%] shadow-sm">
                      Yes we do! Go ahead and shut off the main water valve if
                      you can. What city are you located in? I'll have the owner
                      call you the second he is free.
                    </div>
                  </div>
                  <div className="flex justify-start">
                    <div className="bg-gray-200 text-slate-900 rounded-2xl rounded-tl-sm px-4 py-2 text-sm max-w-[80%]">
                      We are in Irving. Thank you, I'll turn it off now and wait
                      for his call.
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-xl text-slate-600">
              If our AI catches just one missed call a month, it pays for itself
              for the entire year.
            </p>
          </div>
          ...
          <div className="max-w-lg mx-auto">
            <div className="bg-slate-900 rounded-3xl p-8 text-white shadow-2xl relative transform hover:-translate-y-1 transition-transform duration-300">
              ...
              <p className="text-slate-400 mb-6">
                Everything you need to stop losing jobs.
              </p>
              <div className="mb-8">
              ...
              <a
                href="#contact"
                className="block w-full bg-blue-600 hover:bg-blue-500 text-white text-center font-bold py-4 rounded-xl transition-colors"
              >
                Start 14-Day Free Trial
              </a>
      ...
      <div id="contact" className="bg-blue-600 py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white mb-6">
            Ready to stop losing money to your competitors?
          </h2>
          <p className="text-xl text-blue-100 mb-10">
            Join the DFW contractors who are using AI to book jobs while they
            sleep. Try it 100% free for 14 days.
          </p>
          ...
          <div className="bg-white rounded-2xl p-8 max-w-md mx-auto shadow-2xl">
            ...
            <form className="space-y-4 text-left">
              <div>
                ...
                <input
                  type="text"
                  className="w-full border border-slate-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-600 focus:border-transparent outline-none"
              ...
              <button
                type="button"
                className="w-full bg-slate-900 text-white font-bold py-3 rounded-lg hover:bg-slate-800 transition-colors mt-4"
              >
                Get My Free Trial
              </button>
            </form>
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="text-sm">
            &copy; {new Date().getFullYear()} Lone Star Systems. Based in
            Dallas, TX.
          </div>
        </div>
      </footer>
