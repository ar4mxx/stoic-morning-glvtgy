...
import { PhoneMissed, ArrowRight, CheckCircle, ShieldCheck, TrendingUp, Hexagon, ArrowLeft } from 'lucide-react';

export default function App() {
  // State to toggle between the landing page and the privacy policy
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans text-zinc-900">
          ...
          <div className="flex justify-between h-20 items-center">
            ...
            <div className="flex items-center">
              <button 
                ...
                className="bg-emerald-600 text-white px-6 py-2.5 rounded-full font-bold hover:bg-emerald-700 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
              >
      ...
      {/* CONDITIONAL RENDERING: Shows either Privacy Policy OR the Landing Page */}
      {showPrivacy ? (
        
        /* PRIVACY POLICY PAGE */
        <div className="bg-white py-24 min-h-screen border-b border-zinc-200">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <button 
              onClick={() => setShowPrivacy(false)} 
              className="flex items-center text-zinc-500 hover:text-black mb-8 transition-colors font-medium"
            >
            ...
            <div className="prose prose-zinc max-w-none text-zinc-600 space-y-6 text-lg leading-relaxed">
              ...
              <h2 className="text-2xl font-bold text-black mt-10 mb-4">1. Information Collection and Use</h2>
              ...
              <h2 className="text-2xl font-bold text-black mt-10 mb-4">2. SMS & Mobile Data Policy</h2>
              {/* CRITICAL TWILIO COMPLIANCE BLOCK */}
              ...
              <h2 className="text-2xl font-bold text-black mt-10 mb-4">3. Opting Out</h2>
              ...
              <h2 className="text-2xl font-bold text-black mt-10 mb-4">4. Contact Us</h2>
      ...
      <footer className="bg-black text-zinc-500 py-12 border-t border-zinc-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex flex-col md:flex-row items-center md:space-x-8 text-sm">
            <button 
              onClick={() => {
                setShowPrivacy(true);
                window.scrollTo(0, 0);
              }} 
              className="hover:text-white transition-colors mb-4 md:mb-0"
            >
              Privacy Policy
            </button>
            <span>&copy; {new Date().getFullYear()} Lone Star Systems. Proudly serving the USA.</span>
          </div>
        </div>
      </footer>
    </div>
